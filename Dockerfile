...
# That same injected CSS also resizes the logo: the app's auth-screen container
# is a short, wide strip (h-10) sized for the old wide logo, so a square logo
# would render ~40px tall — the rule gives it a real height and centers it.
